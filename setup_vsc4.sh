# ====================================================================================== #
# Script for copying over files into VSC4 cluster to prep.
...
rsync -avz --delete \
    ...
    --exclude 'collect.sh' --exclude 'distribute.sh' --exclude 'fetch.*' \
    --info=progress2 --copy-links \
    *.sh \
    run.py \
    pickle_model.py \
    ~/Dropbox/Research/scotus4/py/pyutils \
    vsc4:~/Dropbox/Research/scotus4/py/
